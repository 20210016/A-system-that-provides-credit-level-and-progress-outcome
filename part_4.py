...
#cheking errors
    ...
    if PASS == 120 :
        ...
        myfile.write("progress - " +str(PASS)+","+str(DEFER)+","+str(FAIL)+"\n")
        
    elif PASS == 100 and DEFER == 20 and FAIL== 0:
        print ("progress (module trailer)")
        trai += 1
        Trailer_list .append (star)
        myfile.write("progress (module trailer)-  "+ str(PASS)+"," + str(DEFER)+"," +str(FAIL)+"\n")
        ...
        myfile.write("module retriever - "+ str(PASS)+"," + str(DEFER)+"," +str(FAIL)+"\n")
        ...
        myfile.write("exclude- "+ str(PASS)+"," + str(DEFER)+"," +str(FAIL)+"\n")
...
while True:
    ...
    myfile=open('histogram.txt','w')
    main()
    myfile.close()

    myfile = open("histogram.txt", "r")
    output = myfile.read()
    print(output)
